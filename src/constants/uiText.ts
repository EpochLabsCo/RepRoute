export const uiText = {
  ...
  navigation: {
    ...
    screenMeta: {
      ...
      'company-catalog': {
        ...
        subtitle: 'Alphabetical list of saved companies, contacts, and visit history.',
      },
    },
    accountMenu: {
  ...
  search: {
    ...
    locationPanel: {
      ...
      recommendedHelper:
        'Enable location to search businesses within your selected mileage radius.',
      locating: 'Locating…',
  ...
  companyCatalog: {
    ...
    description:
      'Your saved companies in one alphabetical catalog with contacts, notes, follow-ups, and visit history.',
    searchLabel: 'Search',
    searchPlaceholder: 'Search companies or contacts',
    addCompany: 'Add Company',
    companyCount: (count: number) =>
      `${count} compan${count === 1 ? 'y' : 'ies'} in catalog`,
    indexLabel: 'Jump to letter',
    detailEyebrow: 'Company details',
    close: 'Close company details',
    openCompanyCatalog: 'Company Catalog',
    openCompanyCatalogWithCount: (count: number) => `Company Catalog (${count})`,
    ...
    followUpUnscheduled: 'Follow-up scheduled',
    noFollowUp: 'No follow-up scheduled',
    noVisitHistory: 'No visit history yet',
    visitUndated: 'Visit date unknown',
    noBusinessCard: 'No business card on file',
    statusYes: 'Yes',
    statusNo: 'No',
    crmNotExported: 'Not exported',
    emptyTitle: 'No companies in catalog',
    emptyCopy: 'Add a company manually or save prospects from Search to build your catalog.',
    exportedToast: 'Company exported to CRM.',
    addedToast: 'Company added to catalog.',
    legend: {
      catalog: 'In catalog',
      saved: 'Saved',
      onRoute: 'On route',
    ...
    fields: {
      ...
      priority: 'Priority',
      notes: 'Notes',
      notesPlaceholder: 'Add company notes…',
      contactName: 'Name',
      contactTitle: 'Title',
      contactPhone: 'Phone',
      contactEmail: 'Email',
      contactNotes: 'Contact notes',
      savedStatus: 'In catalog',
      routeStatus: 'On route',
      crmStatus: 'CRM export',
    },
    addSheet: {
      eyebrow: 'New company',
      heading: 'Add company',
  ...
  routes: {
    ...
    distanceMetrics: {
      ...
      locationStale: 'GPS location is stale. Refresh for accurate distances.',
      segmentSourceDirections: 'Google Directions (driving)',
      segmentSourceGpsProximity: 'GPS straight-line (active stop only)',
      segmentSourceGpsToStop: 'Google Directions (GPS to next stop)',
      segmentSourceAtRouteStart: 'At route start',
      segmentSourceUnavailable: 'Distance unavailable',
    },
    stopEta: {
    ...
    routeRender: {
      ...
      routeOriginCoordinates: 'Route origin coordinates',
      stopCoordinates: 'Stop coordinates',
      displayedDistanceSource: 'Displayed distance source',
      segmentDistanceSource: 'Route line distance source',
    ...
    mapLegend: {
      ariaLabel: 'Route map pin legend',
      upcoming: 'Upcoming',
      current: 'Current Stop',
      completed: 'Completed',
      food: 'Food Stop',
      invalid: 'Problem Stop',
    },
  ...
  followUps: {
    ...
    unscheduledDateLabel: 'Date not set yet',
    setDate: 'Set Date',
    saveWithoutDate: 'Save without date',
  ...
  crmExport: {
    ...
    openCompanyCatalog: 'Open Company Catalog',
    toggles: {
